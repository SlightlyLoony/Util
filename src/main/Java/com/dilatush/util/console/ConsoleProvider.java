...
/**
 * An abstract base class for console provider implementations.  It creates a thread to read the input stream, calling the
...
public abstract class ConsoleProvider {
    ...
    /**
     * Write the given string to the console client and then flush the writer for immediate transmission.  No newline is added to the string.
     *
     * @param _line The string to send to the console client.
     */
