 ...
 */
public class ReadableFileValidator extends AValidatorParser implements ParameterValidator {
     ...
     * is a file that can be read.  Otherwise a {@link Result} instance with {@link Result#valid} set to {@code false} and
