...
public class SingleOptionalArgDef extends AOptionalArgDef {
    ...
    public SingleOptionalArgDef( final String _referenceName, final String _summary, final String _detail,
        ...
        if( parser == null )
            throw new IllegalArgumentException( "No parameter parser supplied for argument: " + parser );
        if( validator == null )
            throw new IllegalArgumentException( "No parameter validator supplied for argument: " + validator );
    }
}
